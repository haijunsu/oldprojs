...
<BODY>
  <%bgd.executeSelect("select c.class_name AS class_name,c.pass_stander as pass_stander,u.test_date AS test_date,u.test_mark AS test_mark from t_result u,t_class c where u.user_id='"+session.getAttribute("userid")+"' and c.class_id=u.class_id order by class_name,test_date desc");
%>
<table class=table003 border="0" width="100%" bgcolor="#FF9966">
  <TR> 
    <TD height="20"><B><font color="#FFFFFF">我的成绩单</font></B><font color="#FFFFFF">================(您共参加过<%=bgd.getRowCount()%>门次课程考试)</font></TD>
  </TR>
</table>
<TABLE class=table002 border="1" cellspacing="0" cellpadding="0" align="center" bordercolorlight="#000000" bordercolordark="#FFFFFF" width="100%">
  ...
  <TR bgcolor="#FFFFFF"> 
    ...
    <TD nowrap><%=eds.format(bgd.getFieldValue("test_date",i),4)%></TD>
