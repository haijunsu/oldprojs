...
function transfer()
{
	<%bgd.executeSelect("select notes from t_lesson_log where user_id='"+session.getAttribute("userid")+"' and class_id="'+request.getParameter("classid")+'" and lesson_id="'+request.getParameter("lessonid")+'"");%>
	var value1 = "" ;
	value=<%=bgd.getFieldValue("notes",0)%>;
