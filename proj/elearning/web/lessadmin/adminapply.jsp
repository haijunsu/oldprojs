...
out.print("您还没有登录，点击<a href=" + request.getContextPath() + "'/login.jsp'>这里</a>登陆！");
}
else{
%>
      ...
      <td bgcolor="#ffffff"> 
        <table border="1" cellspacing="0" cellpadding="0" align="center" bordercolorlight="#000000" bordercolordark="#FFFFFF" class="xbz" width="95%">
          <tr  bgcolor="#CCCCCC" align="center" Height="25"> 
            <td width="20%" align="center" height="20">申请人</td>
            <td width="27%" align="center" height="20">申请的课程</td>
			<td width="23%" align="center" height="20">申请时间</td>
            <td width="30%" align="center" height="20">申请原因</td>
          </tr>
          ...
          <tr bgcolor="#eeeeee" align="center"> 
            <td height="20" colspan="4"> 
              ...
              选中所有 
              <input type="submit" name="Submit" value="批准" onclick="return ok()" >
