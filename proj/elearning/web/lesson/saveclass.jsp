...
sqlbean.execute("insert into tclass(class_id,class_name,class_type,keywords,detil,class_time,pass_stander,class_status) values('"+class_id+"'+right('"+rightid+"',6),'"+name+"','"+di+"','"+key+"','"+desc+"','"+request.getParameter("classtime")+"','"+biaozhun+"','0 ')");
