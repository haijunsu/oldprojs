...
<p class="errMsg">
<bean:message key="errors.500.msg"/>
</p>
</td>
</tr>
</table>
...
<log:error category="jsp">error_500.jsp - <%=exception.toString()%> - [<req:parameters id="param" ><bean:write name="param" property="name"/>=<bean:write name="param" property="value"/>;</req:parameters>]
