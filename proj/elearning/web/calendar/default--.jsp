...
<%@ include file="../inc/open.jsp"%>
<html>
<head>
<link rel="stylesheet" href="xbz.css" type="text/css">
<link rel="stylesheet" href="td" type="text/css">
<body>
 ...
 var s,v,festival,ss;
   ...
   if(sObj.innerHTML!='') {
      ...
      if(cld[d].solarTerms == '' && cld[d].solarFestival == '' && cld[d].lunarFestival == '')
         ...
         festival = '<TABLE WIDTH=100% border="1" cellspacing="0" cellpadding="0" align="center" bordercolorlight="#000000" bordercolordark="#FFFFFF"><TR><TD>'+
         '<FONT COLOR="#000000" STYLE="font-size:9pt;">'+cld[d].solarTerms + ' ' + cld[d].solarFestival + ' ' + cld[d].lunarFestival+'</FONT></TD>'+
         '</TR></TABLE>';
	     ss=cld[d].sYear+'-'+cld[d].sMonth+'-'+cld[d].sDay;
		// alert(cld[d].sYear);
		<%String sql="select year(user_day) as jj ,month(user_day)as dd,notes from tuser_daliy";
		ResultSet rs=stmt.executeQuery(sql);
		if (rs.next()){
		String vv=rs.getString("jj");
		//Int mm=Integer.parseInt(rs.getString("dd"))
		
	   %> 
		if (cld[d].sYear==<%=vv%>||cld[d].sMonth==<%=Integer.parseInt(rs.getString("dd"))%>)
		{

      s= '<form name="form1" method="post" action="daliyadd.jsp"> <TABLE WIDTH="130" border="1" cellspacing="0" cellpadding="0" align="center" bordercolorlight="#000000" bordercolordark="#FFFFFF" bgcolor="#FFFFcc"><TR><TD>' + '<FONT COLOR="#000000" STYLE="font-size:9pt;">'+'姓名：'+'<input type="text" name="name" value="da" size="10" readonly="true">'
       +'<br>'+ '内容'+'<textarea name="content" cols="30" rows="4">在些输入您的日记，些信息可删除。</textarea>'+'<input type="submit" name="Submit" value="提交" style=height:18;width:30>'+'</FoNT>'+'</TD></TR></TABLE> </form>';
		}
...
function mOut() {
 if ( cnt >= 1 ) { sw = 0 }
 if ( sw == 0 ) { snow = 0; dStyle.visibility = "visible";}
 else cnt++;
}
...
<FORM name=CLD>
  <div align="center"> 
    <table width="672" height="259" bordercolordark="#CC9900" border="1" background="l11.gif">
      <center>
        <center><tbody>
        </center>
      </center>
      <tr> 
        <td align=middle valign=top width="170" height="255"> 
          <div align="center"> 
            <center>
              <table border=0 colspan=2 width="221">
                <center>
                  <center>
                    <td width="209">
                      <p align="center"> <font size=2 
      style="FONT-SIZE: 9pt"><font style="font-size:10.8pt" color=RED>本地计算机时间:</font></font><br>
      ...
      id=Clock size=3 align="center"></font> 
          ...
          <div align="center"> 
            <center>
              <table border=0 height="1" width="16">
                <td height="1" width="255"> 
                  <table width="212" height="1">
                    <center>
                      <center>
                        <font id=tSave 
      style="COLOR: red; FONT-FAMILY: Wingdings; FONT-SIZE: 18pt"></font> 
            ...
            style="FONT-SIZE: 9pt">
                            <select name=D1 onChange=changeLong()   
            style="FONT-SIZE: 9pt">
                              <script language=JavaScript><!--  
            for(i=1900;i<2050;i++) document.write('<option>'+i)  
            //--></script>
            ...
            style="FONT-SIZE: 9pt">
                            <select name=D2 onChange=changeLong()   
            style="FONT-SIZE: 9pt">
                              <script language=JavaScript><!--  
            for(i=1;i<13;i++) document.write('<option>'+i)  
            //--></script>
                          ...
                          <div align="center" style="width: 4; height: 1"> </div>
                        <td width="1" align="center" height="1"> <button onClick="pushBtm('MU')"  style="FONT-SIZE: 9pt">月↑</button> 
                    ...
                    <tr> 
                      <center>
                        <td align=center valign=top width=152 height="1"> <button onClick="pushBtm('YU')" style="FONT-SIZE: 9pt">年↑</button>&nbsp; 
                          <button onClick="pushBtm('YD')" style="FONT-SIZE: 9pt">年↓</button>&nbsp; 
                        </td>
                      </center>
                      <td colspan=2 width="46" height="1"> 
                        <p align="left">
                          <input onClick="javascript:window.close();" style="FONT-SIZE: 9pt" type=button value=关闭 name="button">
                        </p>
                      </td>
                  </table>
                  <center>
          ...
          <div align="center"> 
            <center>
              <table border=0 height="27" cellspacing="1">
                <tr> 
                  <td colspan=7 align="center" height="24" class="xbz">&nbsp;</td>
                </tr>
                <tbody> 
                <tr> 
                  <td bgcolor=#000080 colspan=7 align="center" height="24" class="xbz"><font color=#000080 size=2                                                                                                     
            ...
            size=4></font><br>
                ...
                <tr align=middle> 
                  ...
                  <td width=54 height="1" align="center" bgcolor="#99CCFF"><font size="2">六</font></td>
                </tr>
                <script language=JavaScript><!--                                                                                                  
            var gNum                                                                                                  
            for(i=0;i<6;i++) {                                                                                                  
               ...
               for(j=0;j<7;j++) {                                                                                                  
                  gNum = i*7+j                                                                                                  
                  document.write('<td id="GD' + gNum +'" onClick="mOvr(' + gNum +')" onMouseOut="mOut()"><font id="SD' + gNum +'" size=2 face="Arial Black"')                                                                                                  
...
<form name="form1" method="post" action="search.jsp">
  <table width="672" border="0" cellspacing="0" cellpadding="0" align="center" class="xbz">
    <tr> 
      <td>输入格式：yyyy-mm-dd 
        <input type="text" name="time" size="15" value="查看某天的日记">
        <input type="submit" name="Submit" value="提交" style=height:18>
      </td>
    </tr>
  </table>
</form>
