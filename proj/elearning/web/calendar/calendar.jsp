...
%> 
<body> 
<FORM name="sm" method="post" action="<%=request.getContextPath()%>/servlet/calendar/Calendar.jsp"> 
...
<tr> 
     ...
     <a href="<%=request.getContextPath()%>/servlet/calendar/Calendar?year=<%=year%>&month=<%=Integer.parseInt(month)+1%>&date=<%=days[i]%>"  target="calendarTop"><%=days[i]%></a></td> 
    <% } %> 
  </tr> 
<% }  %> 
</div> 
...
<td width=28%><input class="input1" type=text name="year" value=<%=year%> size=4 maxlength=4></td> 
<td>年</td> 
<td width=28%><input class="input2" type=submit value="提交"></td> 
</tr> 
</table> 
</FORM> 
<script Language="JavaScript"> 
