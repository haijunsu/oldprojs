...
{	
	...
	{
	 confirm("realy want send a empty message");
	 return false;
	}
   return true
...
<%
	...
	System.out.println("xlq: after send command it's come here msg: "+msg);
	Vector message=null;
	...
	//System.out.println("display the msg"+msg.toString());
		...
		//out.println("the message size===="+message.size());
		...
		if(displaymessage!=null)
		{
			...
			if(messageindex.intValue()!=displaymessage.size())
			{
				...
				{	
					...
					{
						String name="";
					name=(String)session.getAttribute("userid");//add
  ...
  <table border="0" width="100%" cellpadding="0" cellspacing="0">
    ...
    <tr> 
      <td height="29" colspan="2" valign="top"> <%=username%>: 
        ...
        &nbsp; </td>
      <td></td>
      <%//System.out.println("xlq: it into send button");%>
    </tr>
  </table>
				</form>
				</body>
