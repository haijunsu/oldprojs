  ...
  <table border="1" cellspacing="0" width="100%" cellpadding="0" bgcolor="#eeeeee">
    ...
    try
    {
      ...
      String notice_id=" ",to_time=" ";
	   ...
	   File fi=new File("\\websphere\\AppServer\\installedApps\\elearning.ear\\elearning.war\\elearning\\booksmaking");
    ...
    %>
    <tr >
      <td width="30%"><a href="lessonmade.jsp?bz=<%=aa[i]%>" ><%=tmpname%></a></td>
