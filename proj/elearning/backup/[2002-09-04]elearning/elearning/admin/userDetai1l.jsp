...
<p align="center">
<%bgd.executeSelect("select * from t_user where user_id='"+request.getParameter("userid")+"'");
//if (bgd.getFieldValue("user_right",0)=="38"){
//bgd.executeSelect("select * from t_user where user_id='"+request.getParameter("userid")+"'");
//}

%>

<%=bgd.getFieldValue("user_id", 0)%>详细信息</p>
<FORM id="detailForm" name="detailForm" acton="userDetail" method="post">
  <TABLE border="1" width="94%" align="center">
    <TR>
		<TD>姓名</TD>
