...
<BODY>
<A href="/elearning/" target=_top>首页</A>><A href="lessonReqManager<% %>">必修课指定</A>&gt;<%=catalog%>
...
<TABLE border="1" cellspacing="0" cellpadding="0" align="center" bordercolorlight="#000000" bordercolordark="#FFFFFF" class="xbz" width="100%">
	...
	<TR>
      ...
      <TD> <A href=/elearning/lesson/lesson.jsp?classid=<%=bgd.getFieldValue("class_id", i+(pageNum-1)*listCount)%> target=_blank><%=bgd.getFieldValue("class_name", i+(pageNum-1)*listCount)%></A>&nbsp;
      </TD>
