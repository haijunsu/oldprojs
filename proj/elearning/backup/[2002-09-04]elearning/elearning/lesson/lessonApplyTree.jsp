...
<SCRIPT Language="JavaScript">
	parent.right.location.href = "/servlet/lesson/lessonApplyList?applyType=<%=applyType%>&action=<%=action%>&codeid=<%=codeid%>&codevalue=<%=codevalue%>&message=<%=message%>";
</SCRIPT>
<%
}
%>
...
<BODY vlink="#0000ff" background="/elearning/images/2.gif">
øŒ≥Ã∑÷¿‡
<BR>
<%= tree.renderHTML() %>
<%
