 ...
 //==========================================================================
  ...
  public noticeDO getDataByNo(String notice_id) throws RemoteException, Exception
  {
       ...
       try
       {
          ...
          stmt = "select notice_id,user_id,rtrim(notice_name),rtrim(notice_content),notice_time,valid_time,to_time from t_notice where notice_id = ?  ";
...
//////////////
...

    {
        ...
        try
        {
            ...
            InsertNoticeData(ntcDO) ;
            //con.commit();

        }
    	catch (Exception e)
    	{
            System.out.println("notice save exception:!"+ e.getMessage() + "\n");
            throw new RemoteException (e.getMessage());
    	}
        finally
        {
    ...
    public boolean DeleteNoticeData(String notice_id) throws RemoteException, Exception
    {
        ...
        try
        {
		  ...
		  // System.out.println("DeleteNoticeData begin!");
           ps = con.prepareStatement("delete from t_notice where notice_id = ?");
           ps.setString(1,notice_id);
...
//==========================================================================
	...
	// MODIFY:
	//==========================================================================
    public void InsertNoticeData(noticeDO ntcDO) throws RemoteException, Exception
    {
        ...
        try
        {
            ...
            ps = con.prepareStatement("insert into t_notice values(?,?,?,?,?,?,?,?,?)") ;
            ...
            //ps.setString(8, ntcDO.getNotice_class());       //通知类别
