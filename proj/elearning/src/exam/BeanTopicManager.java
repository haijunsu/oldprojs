...
public class BeanTopicManager extends HttpServlet implements java.io.Serializable
{
	...
	public void doProcess(HttpServletRequest req, HttpServletResponse res) throws ServletException
	{
		...
		catch(Exception ex)
		{
			try
			{
				System.err.println("BeanTopicManager error: " + ex);
				strErrPage = getParameter(req, "errPage", false, true, true, "");
				ex.printStackTrace();
			...
			{
				System.err.println("BeanTopicManager调用错误页面时出错！");
				e.printStackTrace();
			}
		}
    }
