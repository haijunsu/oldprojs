...
public class beanUserDetail extends HttpServlet
{
	//初始化Servlet
        ...
        try
        {
            ...
            if(ets.isAdmin(s_userId))
            {
                 if(s_action.equalsIgnoreCase("update"))
                {
                    ...
                    int int_userRight=Integer.parseInt(s_userRight);
                    
					
                    s_sql = "UPDATE t_user SET group_id = '" + s_groupId + "', " + " user_status = '" + s_userStatus + "', " + " user_right = " + int_userRight + " " + " WHERE user_id = '" + s_queryId + "'";
                }
