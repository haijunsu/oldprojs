...
public class Tauthor implements Serializable {
	...
	private String chvAuthorAccount;
	
	private Boolean bitIsParticipant;
	...
	/**
	 * @return Returns the bitIsParticipant.
	 */
	public Boolean getBitIsParticipant() {
		return bitIsParticipant;
	}
	/**
	 * @param bitIsParticipant The bitIsParticipant to set.
	 */
	public void setBitIsParticipant(Boolean bitIsParticipant) {
		this.bitIsParticipant = bitIsParticipant;
	}
	/**
	...
	/**
	 * @return Returns the chvAuthorAccount.
	 */
	public String getChvAuthorAccount() {
		return chvAuthorAccount;
	}
	/**
	 * @param chvAuthorAccount The chvAuthorAccount to set.
	 */
	public void setChvAuthorAccount(String chvAuthorAccount) {
		this.chvAuthorAccount = chvAuthorAccount;
		this.chvUserAccount = chvAuthorAccount;
	}
    /** 
     *            @hibernate.id
