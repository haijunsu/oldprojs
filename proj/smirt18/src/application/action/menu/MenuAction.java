 ...
 *
 * $Header: /navysu/Smirt18/src/application/action/menu/MenuAction.java,v 1.1 2005/01/20 03:14:23 navy Exp $
...
public class MenuAction extends BaseDispachAction {
    ...
    public ActionForward leftMenuList(ActionMapping mapping, ActionForm form,
        ...
        try {
            ...
            MyQuerys[] _querys = _querysDao.listAll();
            request.setAttribute("querysMenu", _querys);
