/*
 * @(#)homeworldUserLifeForm.java  2004-3-4
 * 
 ...
 */
		 ...
		 * @author 李永初
		 */
		public class homeworldUserLifeForm extends ActionForm {
			...
			*/
			...
			private String[] hiddenbeg= null;//用户id
			private String[] hiddenend= null;//用户id
			 ...
			 * @param string
			 */
			public void setLifedate(String string) {
				lifedate = string;
			}
			 ...
			 * @param strings
			 */
			public void setHiddenbeg(String[] strings) {
				hiddenbeg = strings;
			}
			 ...
			 * @param strings
			 */
			public void setHiddenend(String[] strings) {
				hiddenend = strings;
			}
