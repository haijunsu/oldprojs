...
var tbBoard=document.createElement("table");
  ...
  /************** 设置各功能按钮的功能 *********************/
   ...
   calendar.prevMonth.onmousedown=function(){
    ...
    var temp="00"+calendar.currentDate[1];
    calendar.currentDate[1]=temp.substring(temp.length-2);
    
    calendar.show(calendar.target,calendar.currentDate[0]+"-"+calendar.currentDate[1]+"-"+calendar.currentDate[2],calendar.source);
   }
   /*********** Calendar Today Button ***************/
   calendar.goToday = calendar.insertTbCell(trRow,2,"今 天","center",3);
  ...
  this.setDefaultDate=function(){
   ...
   temp="0"+(dftDate.getMonth()+1);
   
   calendar.today[1]=temp.substring(temp.length-2);
   temp="0"+dftDate.getDate();
   
   calendar.today[2]=temp.substring(temp.length-2);
  }
...
strAbout+="今日\t: 返回当天日期\n";
   strAbout+=">\t: 下一月\n";
   strAbout+="<<\t: 下一年\n";
   //strAbout+="\nAgetimeCalendar\nVersion:v1.0\nDesigned By:暂停打印 2004-03-16  lyc98370118@hotmail.com \n";
   alert(strAbout);
  }
